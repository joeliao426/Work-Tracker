...
minutes = st.sidebar.text_input("How many minutes can you work each day? (Example: Wednesday = 120, Thursday = 50)")
...
Their available time each day is {minutes_available} minutes. Minutes, not hours. The time is also the time they will take to complete it as of typing it.
They have to go to sleep at {sl} pm
Make sure you take into account their personal needs in {extrainfo}
